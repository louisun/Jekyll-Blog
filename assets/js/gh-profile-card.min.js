...
(function(){
    ...
    var DOMOperator = (function () {
        ...
        DOMOperator.createProfile = function (data) {
            ...
            var $followContainer = followContainer([$followButton]);
    ...
    var GitHubCardWidget = (function () {
        ...
        GitHubCardWidget.prototype.render = function (options, error) {
            ...
            $profile.appendChild(this.createBioSection(this.userData.profile));
        ...
        GitHubCardWidget.prototype.createBioSection = function (profile) {
